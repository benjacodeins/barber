...
Optimizado para desarrollo local y deploy en PythonAnywhere.
"""
...
# Para PythonAnywhere, agregar: 'tu-usuario.pythonanywhere.com'
if not DEBUG:
...
# Login configuration
LOGIN_URL = 'reservas:panel_login'
LOGIN_REDIRECT_URL = 'reservas:panel'
